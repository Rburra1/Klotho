...
Companion to [Strand](https://strand.rithvikburra.com). Where Strand is the cloud-API chat surface, Loom is the from-scratch model: ~10 million parameters, character-level, no Hugging Face, no third-party model code. Just the math.
...
```
model.py        Loom + LoomConfig: the transformer itself, ~200 lines
